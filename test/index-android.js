...
describe('Android purchases', () => {
  ...
  describe('#getProducts()', () => {
    ...
    it('should return an array of objects', async (done) => {
      try {
        const products = [
          { productId: 'com.test.prod1', title: 'prod1 title', description: 'prod1 description', price: '$0.99', currencyCode: 'USD', decimalPrice: '0.99' },
          { productId: 'com.test.prod2', title: 'prod2 title', description: 'prod2 description', price: '$1.99', currencyCode: 'USD', decimalPrice: '1.99' },
        ];
